...
If you are still learning the product model, read [Workspace](/concepts/workspace) before wiring production flows.
...
If your flow depends on grouped audiences, review customer pools, target audience lists, cohort segments, and notification groups in [Core Concepts](/concepts).
