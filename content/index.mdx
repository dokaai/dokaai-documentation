...
- [Quickstart](/quickstart): the shortest path to understand the workspace, configure a handler, and send a test notification.
- [Core Concepts](/concepts): product vocabulary and how the main Dokaai objects fit together.
- [Workspace](/concepts/workspace): how organizations, projects, members, and services are organized.
